    ...
    <main className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-black text-white p-12">
        ...
        <div className="max-w-md">
          <blockquote className="text-2xl font-bold leading-snug tracking-tight">
            "Register apps, test scoped access, and ship with a review flow designed for production."
          </blockquote>
      ...
      <div className="flex items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-lg space-y-8">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground">Create your developer account</h1>
